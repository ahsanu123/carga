...
use alloc::boxed::Box;
use carga::platforms::esp32s3_async::backend::Esp32AsyncBackend;
use carga::platforms::esp32s3_async::draw_buffer::DrawBuffer;
use carga_ui::TmdApp;
use defmt::info;
use defmt::println;
...
async fn main(spawner: Spawner) {
    ...
    let st7789 = mipidsi::Builder::new(carga::display_models::st7789_modified::ST7789, di)
